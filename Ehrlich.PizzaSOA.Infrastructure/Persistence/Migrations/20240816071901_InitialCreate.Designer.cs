...
namespace Ehrlich.PizzaSOA.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240816071901_InitialCreate")]
            ...
            modelBuilder.Entity("Ehrlich.PizzaSOA.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 16, 15, 19, 1, 352, DateTimeKind.Local).AddTicks(2671))
            ...
            modelBuilder.Entity("Ehrlich.PizzaSOA.Domain.Entities.OrderDetail", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2024, 8, 16, 15, 19, 1, 352, DateTimeKind.Local).AddTicks(4750))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("Ehrlich.PizzaSOA.Domain.Entities.Pizza", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2024, 8, 16, 15, 19, 1, 351, DateTimeKind.Local).AddTicks(9118))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
                    ...
                    b.Property<string>("PizzaItemCode")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasColumnName("PizzaItemCode");
            ...
            modelBuilder.Entity("Ehrlich.PizzaSOA.Domain.Entities.PizzaType", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2024, 8, 16, 15, 19, 1, 351, DateTimeKind.Local).AddTicks(6660))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
