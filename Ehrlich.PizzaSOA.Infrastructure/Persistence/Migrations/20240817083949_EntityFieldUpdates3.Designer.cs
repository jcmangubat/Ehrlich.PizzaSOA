...
namespace Ehrlich.PizzaSOA.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240817083949_EntityFieldUpdates3")]
    partial class EntityFieldUpdates3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ehrlich.PizzaSOA.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 17, 16, 39, 48, 794, DateTimeKind.Local).AddTicks(9764))
            ...
            modelBuilder.Entity("Ehrlich.PizzaSOA.Domain.Entities.OrderDetail", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2024, 8, 17, 16, 39, 48, 795, DateTimeKind.Local).AddTicks(2287))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("Ehrlich.PizzaSOA.Domain.Entities.Pizza", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2024, 8, 17, 16, 39, 48, 794, DateTimeKind.Local).AddTicks(5295))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
            ...
            modelBuilder.Entity("Ehrlich.PizzaSOA.Domain.Entities.PizzaType", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("DateTime2")
                        .HasDefaultValue(new DateTime(2024, 8, 17, 16, 39, 48, 794, DateTimeKind.Local).AddTicks(2440))
                        .HasColumnName("_dateCreated")
                        .HasColumnOrder(501);
